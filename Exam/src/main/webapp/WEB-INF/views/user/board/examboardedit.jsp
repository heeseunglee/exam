...
<div id="container">
	...
	<div id="mainBlock">
		...
		<form method="post" action="/exam/user/examboardeditok.action?seq=${dto.seq}">
			 <table class="table table-striped">
			     <tr>
			       <th>제목</th>
			       <td><input type="text" name="subject" id="subject" class="form-control" required placeholder="제목" value= "${dto.subject}"/></td>
			     </tr>
			     <tr>
			       <th>내용</th>
			       <td>
			       	<textarea name="content" id="content2" class="form-control" required placeholder="내용">${dto.content}</textarea>
			       </td>
			     </tr>
			     <tr>
			     	<td colspan="2">
			     		<input type="button" value= "취소" onclick="location.href='/exam/user/examboardview.action?seq=${dto.seq}';"/>
