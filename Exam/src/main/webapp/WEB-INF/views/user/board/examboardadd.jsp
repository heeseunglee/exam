...
<div id="container">
	...
	<div id="mainBlock">
		...
		<div id="aside">
			...
			<div id="side_title">커뮤니티ㄴ</div><!-- 제작 페이지의 카테고리 제목 -->
		...
		<div id="content">
			...
			<div id="content_title">시험후기</div><!-- 본문 상단의 타이틀(해당페이지 제목) -->
			
			<div id="content_body">
			<!-- #content_body 박스 : 이하 본문 작성하시면됩니다.  -->	
				
				<form method="post" action="/exam/user/examboardaddok.action?mode=${mode}&thread=${thread}&depth=${depth}">
			 <table class="table table-striped">
			     ...
			     <tr>
			       <th>내용</th>
			       <td>
			       	<textarea name="content" id="content2" class="form-control" required placeholder="내용" style="height:350px;"></textarea>
			       </td>
			     </tr>
			     <tr>
			     	<td colspan="2">
			     		<input type="submit"  id= "btnSubmit" class="btn btn-primary" value= "글쓰기"/>
			     		<input type="button" value= "취소" class="btn btn-default" onclick="location.href='/exam/user/examboardlist.action';"/>
