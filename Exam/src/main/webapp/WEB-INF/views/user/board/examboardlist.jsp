	...
	<div id="mainBlock">
		...
		<table id="tbl" class="table">
				...
				<tr>
					...
					<td>
					${dto.replyImg}
					<a href="/exam/user/examboardview.action?seq=${dto.seq}&searchColumn=${searchColumn}&searchWord=${searchWord}">${dto.subject}</a>
		 ...
		 <!--검색부분 추가  -->
		 <div>
		 	<form method="GET" action="/exam/user/examboardlist.action">
		 ...
		 <!-- 페이징 -->
		  ...
		  <input type="button" value= "글쓰기" class="btn btn-default" onclick="location.href='/exam/user/examboardadd.action';"/>
