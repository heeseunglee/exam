	...
	<div id="mainBlock">
		...
		<div id="content">
			...
			<div id="btnList">
				...
				<input type="button" value="목록보기" class="btn btn-default"  onclick="location.href='/exam/user/usertestnewslist.action?seq=${dto.seq}';">
				</c:if>
				
				<c:if test="${!empty searchColum && !empty searchWord}">
				<input type="button" value="목록보기" class="btn btn-default" onclick="location.href='/exam/user/usertestnewslist.action?seq=${dto.seq}'&searchColum=${searchColum}&searchWord=${searchWord}';"/>
				</c:if>
