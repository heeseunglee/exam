...
<div id="container">
	...
	<div id="mainBlock">
		...
		<div id="content">
			...
			<form method="post" action="/exam/user/freeboardeditok.action?seq=${dto.seq}">
			 <table class="table">
			     <tr>
			       <th>제목</th>
			     ...
			     <tr>
			       <th>내용</th>
			       <td>
			       	<textarea name="content" id="content" class="form-control" required placeholder="내용">${dto.content}</textarea>
			       </td>
			     </tr>
			     <tr>
			     	<td colspan="2">
			     		<input type="button" value= "취소" onclick="location.href='/exam/user/freeboardview.action?seq=${dto.seq}';"/>
