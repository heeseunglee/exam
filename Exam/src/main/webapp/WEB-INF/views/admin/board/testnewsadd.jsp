			...
			<div id="article">
				...
				<div id="location">
					...
					<span>
						...
						<input type="button" value="시험뉴스입력" class="btn btn-xs btn-default" id="home-btn" onclick="location.href='#'" />
					</span>  
				...
				<form method="POST" action="/exam/admin/testnewsaddok.action">
				<table class="table table-striped">
					<tr>
						<th>분류명</th>
						<td>
						<select id="testnewsDIV" name ="testnewsDIV" style="width:20%;" class="form-control">
							<option value="최신뉴스">최신뉴스</option>
					...
					<tr>
						<th>제목</th>
						<td><input type="text" id="testnewssubject" name="testnewssubject" style="width:90%;" class="form-control" required="required" /></td>
					</tr>
					<tr>
						<th>내용</th>
						<td><input type="text" id="testnewscontent" name="testnewscontent" style="width:90%;min-height:150px;" class="form-control" required="required" /></td>
					</tr>
					
				</table>
					<input type="submit" value="등록하기" class="btn btn-default">
					<input type="button" value="목록보기" class="btn btn-default"  onclick="location.href='/exam/admin/testnewslist.action';">	
				</form>
