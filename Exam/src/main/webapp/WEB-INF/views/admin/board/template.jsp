...
<div id="container">
	...
	<div id="mainBlock">
		...
		<div id="content">
			...
			<!-- 검색부분 추가 -->
			<form method="GET" action="/exam/board/list.action">
			...
			<div id="btnList">
				...
				<img src="/resources/images/list.png" onclick="location.href='/exam/board/list.action';" />
				<br />
				<img src="/resources/images/write.png" onclick="location.href=''/exam/board/add.action';" />
			</div>		
		</div>
	</div>
