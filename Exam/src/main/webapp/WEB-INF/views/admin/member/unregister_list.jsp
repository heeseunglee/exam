			...
			<div id="aside">
				...
				<div id="side_menu">
					<ul>						
						...
						<li class="side_select" onclick="location.href='/exam/admin/unregister_list.action'">탈퇴회원목록</li>
				...
				<div id="notice">
					...
					<table id="tbl" class="table">
						...
						<tr>
							...
							<td class="cell6"><input type="button"  class="btn btn-xs btn-success" value="복구" onclick="location.href='/exam/admin/member_reactive.action?seq=${dto.seq}';"/></td>
						</tr>
						</c:forEach>
						
						<c:if test="${list.size() == 0}">
						<tr>
							<td colspan="6" style="text-align: center;padding: 100px 0px;">탈퇴회원이 존재하지 않습니다.</td>
						</tr>
						</c:if>
					</table>
