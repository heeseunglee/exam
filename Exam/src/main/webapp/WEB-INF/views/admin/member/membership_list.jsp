	...
	<div id="container">
		...
		<div id="container_child">
			...
			<div id="aside">
				...
				<div id="side_menu">
					<ul>						
						<li onclick="location.href='/exam/admin/member_list.action'">회원목록</li>
						<li class="side_select" onclick="location.href='/exam/admin/membership_list.action'">유료회원목록</li>
			...
			<div id="article">
				...
				<div id="location">
					...
					<span>
						...
						<input type="button" value="유료회원목록" class="btn btn-xs btn-default" id="home-btn" onclick="location.href='/exam/admin/membership_list.action'" />
					</span>  
				...
				<div id="notice">
					...
					<table id="tbl" class="table">
						...
						<tr>
							...
							<td class="cell6"><input type="button"  class="btn btn-xs btn-warning" value="수정" onclick="location.href='/exam/admin/member_edit.action?seq=${dto.seq}';"/></td>
						</tr>
						</c:forEach>
						
						<c:if test="${list.size() == 0}">
						<tr>
							<td colspan="6" style="text-align: center;padding: 100px 0px;">유료회원이 존재하지 않습니다.</td>
						</tr>
						</c:if>
					</table>
					...
					<!-- 검색부분 추가 -->
					<form method="GET" action="/exam/admin/membership_list.action">
