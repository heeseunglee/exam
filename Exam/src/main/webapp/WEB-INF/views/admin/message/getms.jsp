...
<div id="container">
	...
	<div id="locationBar">
		...
		<div id="locationBar_child">
			...
			<a href="#">받은쪽지함</a>  <!-- 해당페이지 제목(서브메뉴 제목) 과 해당 링크 수정 -->
		</div>	
	...
	<div id="mainBlock">
		...
		<div id="content">
			...
			<div id="content_title">받은 쪽지함</div><!-- 본문 상단의 타이틀(해당페이지 제목) -->
			...
			<table id="tbl" class="table">
				...
				<tr>
					<td colspan="5" style="text-align: center;padding: 100px 0px;"> 받은 쪽지가 없습니다. </td>
				</tr>
				</c:if>
				<c:if test="${list.size()>0}">
