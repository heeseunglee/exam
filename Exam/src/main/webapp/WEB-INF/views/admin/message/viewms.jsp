		...
		<div id="aside">
			...
			<div id="side_menu">
				...
				-->
					...
					<li class="side_select" onclick="location.href='/exam/admin/getms.action'">받은 쪽지함</li>
			...
			<!-- #content_body 박스 : 이하 본문 작성하시면됩니다.  -->	
				...
				<table id="tbl" class="table table-striped">
					...
					<tr>
						<th></th>
						<td>
							<input type="button" value=" 답장 " class="btn btn-default" style="display: inline-block; width: 100px; text-align: right;" onclick="location.href='/exam/admin/addms.action?userId=${dto.userId}';"/>
							<input type="button" value=" 리스트 " class="btn btn-default" style="display: inlin-block; width: 100px; text-align: right;" onclick="location.href='/exam/admin/getms.action';"/>
						</td>
					</tr>
				</table>
